...
async function main() {
    ...
    const adminPsy = await prisma.user.upsert({
        ...
        create: {
            ...
            password_hash: passwordHash,
            role: client_1.Role.ADMIN_PSYCHOLOGIST,
        },
    });
    ...
    await prisma.consultantProfile.upsert({
        ...
        create: {
            ...
            onboarding_status: client_1.OnboardingStatus.COMPLETED,
            onboarding_step: 6,
            phone: '+525512345678',
        }
    });
    ...
    await prisma.consultantProfile.upsert({
        ...
        create: {
            ...
            onboarding_status: client_1.OnboardingStatus.INCOMPLETE,
            onboarding_step: 3,
    ...
    if (!therapy1) {
        therapy1 = await prisma.therapy.create({
            data: {
                ...
                origin: client_1.TherapyOrigin.PSYCHOLOGIST_INITIATED,
                modality: 'virtual',
                status: client_1.TherapyStatus.ACTIVE,
                billing_plan: {
                    create: {
                        billing_type: client_1.BillingType.PER_SESSION,
                        default_fee: 500.00,
                    }
                }
            }
    ...
    const notifications = [
        { id: 'notif-1', type: client_1.NotificationType.SESSION_SCHEDULED, title: 'Sesión Programada', body: 'Tu próxima sesión ha sido confirmada.', read: false },
        { id: 'notif-2', type: client_1.NotificationType.PAYMENT_REGISTERED, title: 'Pago Registrado', body: 'Se ha registrado tu pago de $500.', read: true },
        { id: 'notif-3', type: client_1.NotificationType.GOAL_UPDATED, title: 'Objetivo Actualizado', body: 'Tu progreso en "Reducir ansiedad" ha sido actualizado.', read: false },
        { id: 'notif-4', type: client_1.NotificationType.NEW_MESSAGE, title: 'Nuevo Mensaje', body: 'Tu psicóloga te ha enviado un mensaje.', read: false },
        { id: 'notif-5', type: client_1.NotificationType.PROPOSITION_RECEIVED, title: 'Nuevos horarios propuestos', body: 'Revisa las opciones para tu próxima sesión.', read: false }
    ];
