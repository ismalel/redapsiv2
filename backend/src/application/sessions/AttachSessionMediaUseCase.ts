...
import { IAttachSessionMediaUseCase } from './sessions.use-cases';
import { ApiError } from '../../shared/apiError';

export class AttachSessionMediaUseCase implements IAttachSessionMediaUseCase {
  async execute(sessionId: string, psychologistId: string, mediaUrl: string): Promise<TherapySession> {
